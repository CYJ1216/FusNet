...
def swin_tiny_patch4_window7_224(pretrained=False,num_classes: int = 1000, **kwargs):
    # trained ImageNet-1K
    ...
    model = SwinTransformer(in_chans=3,
                            ...
                            **kwargs)
    if pretrained:
        model_state = torch.load(root_path+'/model/swin_tiny_patch4_window7_224.pth',map_location='cpu')["model"]
